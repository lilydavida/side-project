...
export default function InsightsPage() {
  return (
    <div className="min-h-screen bg-slate-950 px-4 py-8 sm:py-16 font-sans">
      <div className="max-w-4xl mx-auto">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-slate-400 hover:text-slate-300 transition-colors mb-8 text-sm"
        >
          <ArrowLeft size={16} />
        ...
        <article className="prose prose-invert prose-slate max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">The Question Nobody Can Answer</h2>
            ...
            <p className="text-slate-300 leading-relaxed font-medium">My answer: It's potentially a pricing problem.</p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              I started analyzing underutilized GPU capacity, convinced cost optimization was the problem. Primary
            ...
            <div className="bg-slate-900 border-l-4 border-slate-700 pl-6 py-4 my-6">
          ...
          {/* Who I Talked To */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Who I Talked To</h2>
            <p className="text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">
              The Five Layers Within AI Ecosystem (And Who's Making Money)
            </h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">
              Layer 3: Foundation Models (Where The Losses Concentrate)
            </h2>

            <h3 className="text-xl font-semibold text-white mb-3 mt-6">OpenAI's unit economics:</h3>
            ...
            <div className="bg-slate-900 border-l-4 border-slate-700 pl-6 py-4 my-6">
              <p className="text-slate-300 font-semibold">The brutal math:</p>
          ...
          {/* Layer 5 Deep Dive */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Layer 5: Enterprises (The Discovery Problem)</h2>
            <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <div className="bg-slate-900 rounded-lg p-6 my-6">
              <h3 className="text-lg font-semibold text-white mb-4">The Enterprise Dilemma:</h3>
              <p className="text-slate-300 mb-4">
                Spend $2M/year on AI infrastructure running 100 experiments to find ONE that generates $10M revenue.
              </p>

              <h4 className="font-semibold text-white mb-2">Current Pricing Reality:</h4>
              <ul className="space-y-2 text-slate-300 mb-4">
              ...
              <h4 className="font-semibold text-white mb-2">What Enterprises Want:</h4>
              <ul className="space-y-2 text-slate-300">
          ...
          {/* Three Misalignments */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-6">The Three Misalignments</h2>

            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">#1: Hardware Pricing vs Software Consumption</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">#2: Cost-Based vs Value-Based Pricing</h3>
                <p className="text-slate-300 leading-relaxed mb-3">
                ...
                <div className="bg-slate-900 rounded-lg p-4 my-4">
                  ...
                  <p className="text-slate-300 mb-2">• Customer would pay $10,000 (25% of value)</p>
                  <p className="text-slate-300 mb-2">• Provider prices at $300 based on token costs</p>
                  <p className="text-slate-300">• 95% of value left uncaptured</p>
                </div>
                <p className="text-slate-300 leading-relaxed mb-3">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">#3: VC Expectations vs Sustainable Economics</h3>
                <p className="text-slate-300 leading-relaxed mb-3">
          ...
          {/* Solution */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">The Solution: Outcome-Based Pricing</h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Exploration Phase (3-6 months):</h3>
                <p className="text-slate-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Production Phase:</h3>
                <p className="text-slate-300 leading-relaxed mb-3">Pay based on measurable outcomes:</p>
                <ul className="space-y-2 text-slate-300">
              ...
              <div className="bg-slate-900 rounded-lg p-6 mt-6">
                <h3 className="text-lg font-semibold text-white mb-4">Why This Works:</h3>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">1. Measurement Infrastructure Maturity</h3>
                <p className="text-slate-300 mb-2">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">2. Market Precedent Validation</h3>
                <ul className="space-y-2 text-slate-300">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">3. Financial Pressure Creates Urgency</h3>
                <p className="text-slate-300 leading-relaxed">
            ...
            <p className="text-slate-300 leading-relaxed mt-6 font-medium">
          ...
          {/* Case Studies */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-6">Case Study: Gaming</h2>

            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Current Pricing:</h3>
                <p className="text-slate-300">$1.5M/year (GPU $1M + APIs $500K) regardless of engagement impact</p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Outcome-Based Pricing:</h3>
                <p className="text-slate-300 mb-3">
              ...
              <div className="bg-slate-900 rounded-lg p-6 mt-6">
                <h3 className="text-lg font-semibold text-white mb-3">Why It Works:</h3>
                <p className="text-slate-300 leading-relaxed mb-3">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-6">Case Study: Ecommerce</h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-300 ml-6 mb-3">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-3">Phase 3 (Month 6): Evaluation and iteration</h3>
                <ul className="space-y-2 text-slate-300">
